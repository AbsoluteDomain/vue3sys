...
-- 1. 创建数据库
-- ----------------------------
CREATE DATABASE IF NOT EXISTS youlai_admin_django CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;


-- ----------------------------
-- 2. 创建表 && 数据初始化
-- ----------------------------
USE youlai_admin_django;
...
INSERT INTO `sys_menu` VALUES (251, 1, '0,1,251', '字典项', 'M', 'DictItem', 'dict-item', 'system/dict/dict-item', NULL, 0, 1, 0, 6, '', NULL, now(), now(), NULL);
...
INSERT INTO `sys_role` VALUES (8, '系统管理员1', 'ADMIN1', 8, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (9, '系统管理员2', 'ADMIN2', 9, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (10, '系统管理员3', 'ADMIN3', 10, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (11, '系统管理员4', 'ADMIN4', 11, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (12, '系统管理员5', 'ADMIN5', 12, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (13, '系统管理员6', 'ADMIN6', 13, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (14, '系统管理员7', 'ADMIN7', 14, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (15, '系统管理员8', 'ADMIN8', 15, 1, 1, NULL, now(), NULL, NULL, 0);
INSERT INTO `sys_role` VALUES (16, '系统管理员9', 'ADMIN9', 16, 1, 1, NULL, now(), NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `sys_role_dept` VALUES (1, 7, 1);
INSERT INTO `sys_role_dept` VALUES (2, 7, 2);
...
-- 顶级目录
INSERT INTO `sys_role_menu` VALUES (1, 2, 1), (2, 2, 2), (3, 2, 4), (4, 2, 5), (5, 2, 6), (6, 2, 7), (7, 2, 8), (8, 2, 9);
-- 系统管理
INSERT INTO `sys_role_menu` VALUES (9, 2, 210), (10, 2, 2101), (11, 2, 2102), (12, 2, 2103), (13, 2, 2104), (14, 2, 2105), (15, 2, 2106), (16, 2, 2107);
INSERT INTO `sys_role_menu` VALUES (17, 2, 220), (18, 2, 2201), (19, 2, 2202), (20, 2, 2203), (21, 2, 2204), (22, 2, 2205);
INSERT INTO `sys_role_menu` VALUES (23, 2, 230), (24, 2, 2301), (25, 2, 2302), (26, 2, 2303), (27, 2, 2304);
INSERT INTO `sys_role_menu` VALUES (28, 2, 240), (29, 2, 2401), (30, 2, 2402), (31, 2, 2403), (32, 2, 2404);
INSERT INTO `sys_role_menu` VALUES (33, 2, 250), (34, 2, 2501), (35, 2, 2502), (36, 2, 2503), (37, 2, 2504);
INSERT INTO `sys_role_menu` VALUES (38, 2, 251), (39, 2, 2511), (40, 2, 2512), (41, 2, 2513), (42, 2, 2514);
INSERT INTO `sys_role_menu` VALUES (43, 2, 260);
INSERT INTO `sys_role_menu` VALUES (44, 2, 270), (45, 2, 2701), (46, 2, 2702), (47, 2, 2703), (48, 2, 2704), (49, 2, 2705);
INSERT INTO `sys_role_menu` VALUES (50, 2, 280), (51, 2, 2801), (52, 2, 2802), (53, 2, 2803), (54, 2, 2804), (55, 2, 2805), (56, 2, 2806);
-- 代码生成
INSERT INTO `sys_role_menu` VALUES (57, 2, 310);
-- 平台文档
INSERT INTO `sys_role_menu` VALUES (58, 2, 501), (59, 2, 502), (60, 2, 503), (61, 2, 504);
-- 接口文档
INSERT INTO `sys_role_menu` VALUES (62, 2, 601);
-- 组件封装
INSERT INTO `sys_role_menu` VALUES (63, 2, 701), (64, 2, 702), (65, 2, 703), (66, 2, 704), (67, 2, 705), (68, 2, 706), (69, 2, 707), (70, 2, 708), (71, 2, 709);
-- 功能演示 / 多级菜单
INSERT INTO `sys_role_menu` VALUES (72, 2, 801), (73, 2, 802), (74, 2, 803), (75, 2, 804), (76, 2, 910), (77, 2, 911), (78, 2, 912), (79, 2, 913);
-- 路由参数
INSERT INTO `sys_role_menu` VALUES (80, 2, 1001), (81, 2, 1002);
...
CREATE TABLE `sys_user`  (
                             ...
                             `email` varchar(254) NOT NULL DEFAULT '' COMMENT '用户邮箱',
                             `is_staff` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否后台人员',
 ...
 VALUES (1, 'root', '有来技术', 0, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', NULL, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345677', 1, 'youlaitech@163.com', now(), NULL, now(), NULL, 0, NULL, 1, '', '', 1, 1, now());
 INSERT INTO `sys_user` (
                            `id`,
                            `username`,
                            `nickname`,
 ...
 VALUES (2, 'admin', '系统管理员', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', 1, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345678', 1, 'youlaitech@163.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 1, 1, now());
 INSERT INTO `sys_user` (
                            `id`,
                            `username`,
                            `nickname`,
 ...
 VALUES (3, 'test', '测试小用户', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', 3, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345679', 1, 'youlaitech@163.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 0, 1, now());
...
VALUES (4, 'dept_manager', '部门主管', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', 1, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345680', 1, 'manager@youlaitech.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 1, 1, now());
...
VALUES (5, 'dept_member', '部门成员', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', 1, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345681', 1, 'member@youlaitech.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 1, 1, now());
...
VALUES (6, 'employee', '普通员工', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', 2, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345682', 1, 'employee@youlaitech.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 1, 1, now());
...
VALUES (7, 'custom_user', '自定义权限用户', 1, 'pbkdf2_sha256$870000$UBfWR0BiQVMQxHZunSnd6E$1fIe/xBpse4ID7xR+EYI1B9ogqCgP6Bq6k7YdmD0mfU=', NULL, 'https://foruda.gitee.com/images/1723603502796844527/03cdca2a_716974.gif', '18812345683', 1, 'custom@youlaitech.com', now(), NULL, now(), NULL, 0, NULL, 0, '', '', 1, 1, now());
...
INSERT INTO `sys_user_role` VALUES (6, 6, 6);
INSERT INTO `sys_user_role` VALUES (7, 7, 7);
